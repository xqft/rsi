...
PROCESS_THREAD(udp_process, ev, data)
{
  ...
  static char str[250] = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet accumsan ex. Aliquam eu maximus nisi. Maecenas cursus elit id fringilla hendrerit. In at tortor at tortor consectetur facilisis quis sit amet sem. Aliquam fermentum diam sed dolor.";
  static radio_value_t ch_num;
  static uip_ipaddr_t dest_ipaddr;

  PROCESS_BEGIN();

  uip_ip6addr(&dest_ipaddr, 0xfd00, 0x0000, 0x0000, 0x0000, 0x0212, 0x4b00, 0x1204, 0xde22);
